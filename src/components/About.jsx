  ...
  return (
    <div id='about' className='w-full h-screen py-30 flex flex-col gap-15 items-center'>
            ...
            <div className='flex gap-50'>
              <div className='bg-zinc-800 p-8 tracking-tight flex flex-col gap-5 rounded-lg w-130 text-gray-300 shadow-xs shadow-blue-500 hover:shadow-lg hover:shadow-blue-40 duration-500 ease-in-out hover:scale-110'>          
              ...
              <div className='flex flex-col justify-between'>
                <div className='flex self-start flex-col gap-5'>
                  ...
                  <div className='bg-zinc-800 tracking-tight p-8 flex flex-col rounded-lg w-110 shadow-xs shadow-blue-500 hover:shadow-lg hover:shadow-blue-40 duration-500 ease-in-out hover:scale-110'>
                    <div>
                ...
                <div className='flex justify-between'>
                  ...
                  <div href='mailto:ghanisheikh26@gmail.com' className='flex gap-1 py-2 px-3 bg-zinc-800 rounded-lg items-center'>
